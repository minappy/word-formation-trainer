...
Автор: Тестировщик / UI-разработчик
Ветка: feature/ui
"""
...
class SessionTimer:
    ...
    def get_elapsed_time(self):
        ...
        Возвращает:
            str - время в формате "ММ:СС" или "00:00" если таймер не запущен
        """
    ...
    def get_elapsed_seconds(self):
        ...
        Возвращает:
            int - количество секунд или 0 если таймер не запущен
        """
        if not self.start_time:
            return 0
    ...
    def get_formatted_date(self):
        ...
        Возвращает:
            str - дата и время в формате "ДД.ММ.ГГГГ ЧЧ:ММ:СС"
        """
